...
DATADIR="/mnt/hdd1/pibutti/data/ttbar_PU200/mc21_14TeV.601229.PhPy8EG_A14_ttbar_hdamp258p75_SingleLep.recon.RDO.e8481_s4149_r14700" 

export TRF_ECHO=1 
export ATHENA_CORE_NUMBER=32 
echo "ATHENA_CORE_NUMBER=" ${ATHENA_CORE_NUMBER} 


cd ./thread_timing/athena_proc_1_threads_32
